...
public class IntroText3_1 : MonoBehaviour
{
    ...
    {
        yield return ShowText("Головоломка 2: Ланцюг прометея");
        yield return ShowText("Крок 1: Виберіть правильні символи з файлу, щоб відтворити сигнатуру.");
        yield return ShowText("Крок 2: Зіставте їх з картою міста, щоб визначити місце другого фрагмента.");
