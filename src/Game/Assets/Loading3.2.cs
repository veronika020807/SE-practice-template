...
public class IntroText3_2 : MonoBehaviour
{
    ...
    {
        yield return ShowText("Сцена 2: Підземний лабіринт");
        yield return ShowText("Алекс і Лекса пробираються через тунелі, уникаючи патрулів дронів.");
        yield return ShowText("На стінах – графіті з кодами та символами опору.");
