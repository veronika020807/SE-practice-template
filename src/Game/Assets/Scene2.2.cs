...
public class DialogueManager2_2 : MonoBehaviour
{
    ...
    private DialogueLine[] dialogue = new DialogueLine[]
    {
        ...
        new DialogueLine { Speaker = "Narrator", Content = "(З’являється головоломка: гравець має знайти ключ у фрагментах коду батька, розкиданих у файлах.)"},
        new DialogueLine { Speaker = "Alex", Content = "(Під час розв’язання)\nВін завжди говорив: \"Код – це свобода\".\n"},
        new DialogueLine { Speaker = "Narrator", Content = "(Після успіху файл розшифровується. На екрані – голосове повідомлення батька.)"},
