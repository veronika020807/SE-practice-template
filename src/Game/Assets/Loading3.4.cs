...
public class IntroText3_4 : MonoBehaviour
{
    ...
    {
        yield return ShowText("Сцена 3: Серце лабораторії");
        yield return ShowText("У кімнаті – старий сервер із символом \"Прометея\".");
        yield return ShowText("Алекс підключає гаджет, але система вимагає підтвердження особи.");
