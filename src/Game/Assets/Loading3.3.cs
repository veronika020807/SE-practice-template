...
//    {
//        yield return ShowText("Головоломка 3: Лазерний танець");
//        yield return ShowText("Крок 1: Знайдіть візерунок у рухах лазерів.");
//        yield return ShowText("Крок 2: Введіть послідовність кроків, імітуючи алгоритм уникнення.");
